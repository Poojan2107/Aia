...
export function AssistChip() {
  return (
    ...
    >
      <span className="relative flex size-[60px] items-center justify-center rounded-full bg-aia-orange text-white shadow-[0_10px_30px_rgba(218,112,46,0.35)] transition duration-300 group-hover:scale-[1.04]">
