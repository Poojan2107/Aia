...
export function Gallery() {
  ...
  return (
    <section
      className="bg-aia-surface-soft py-20 lg:py-28"
      aria-labelledby="gallery-heading"
    >
      <div className="page-pad mb-12 text-center">
        <SectionLabel className="mb-6">Gallery</SectionLabel>
        <h2
          id="gallery-heading"
          className="display mx-auto mb-6 max-w-[16ch] text-[clamp(2rem,4.5vw,4.5rem)] text-aia-navy"
        >
          See what better performance looks like.
        </h2>
        <p className="mx-auto max-w-2xl text-lg text-aia-navy/65">
      ...
      <div className="relative mx-auto max-w-6xl px-4">
            ...
            return (
              ...
              >
                <Image
                  ...
                  className={`object-cover ${!isActive && Math.abs(offset) > 0 ? "scale-105" : ""}`}
                />
                {isActive ? (
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-aia-navy/70">
          <span className="inline-block size-3 rounded-sm bg-[#ff0000]" aria-hidden />
