...
export const industries: Industry[] = [
  {
    ...
    hotspots: [
      { id: "gear", label: "Ring Gear", x: 22, y: 30, align: "left" },
      { id: "feed", label: "Feed End Liners", x: 34, y: 38, align: "top" },
      { id: "shell", label: "Shell Liners", x: 48, y: 30, align: "top" },
      { id: "liners", label: "High Quality Fasteners", x: 78, y: 32, align: "right" },
      { id: "trunnion", label: "Discharge Trunnion", x: 88, y: 50, align: "right" },
      { id: "de", label: "DE Assembly", x: 72, y: 68, align: "bottom" },
    ],
  },
  {
    id: "cement",
