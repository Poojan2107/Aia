...
export const industries: Industry[] = [
  {
    ...
    hotspots: [
      { id: "gear", label: "Ring Gear", x: 16, y: 34, align: "left" },
      { id: "feed", label: "Feed End Liners", x: 30, y: 40, align: "top" },
      { id: "shell", label: "Shell Liners", x: 48, y: 32, align: "top" },
      { id: "liners", label: "High Quality Fasteners", x: 72, y: 28, align: "right" },
      { id: "trunnion", label: "Discharge Trunnion", x: 86, y: 48, align: "right" },
      { id: "de", label: "DE Assembly", x: 78, y: 62, align: "bottom" },
    ],
  },
  {
    id: "cement",
    ...
    hotspots: [
      { id: "gear", label: "Ring Gear", x: 18, y: 30, align: "left", tone: "slate" },
      { id: "lining", label: "Lining System", x: 42, y: 28, align: "top" },
      { id: "diaphragm", label: "Diaphragms", x: 58, y: 45, align: "right", tone: "slate" },
      { id: "fasteners", label: "High Quality Fasteners", x: 74, y: 26, align: "right" },
      { id: "media", label: "Grinding Media", x: 50, y: 68, align: "bottom", tone: "slate" },
    ],
  },
  {
    id: "quarry",
  ...
  },
  {
    ...
    hotspots: [
      ...
      { id: "discharge", label: "Discharge Outlet", x: 50, y: 88, align: "bottom" },
    ],
  },
];
